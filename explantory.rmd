...
## Data collect, clean and integrate
...
des = c(st,adjinc,fod1p,fod2p,sch,schg,schl,indp,naicsp,sex,rac1p,pincp,agep,citwp,cow,serialno)
des_table = cbind(name,des)
print(des_table)
```
### Clean and Integrate:
