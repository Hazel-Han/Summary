...
dim(edu)
names(edu)
edu_clear = edu[,c("ST","ADJINC","FOD1P","SCH","SCHG","SCHL","INDP","NAICSP","SEX","RAC1P","PINCP","AGEP","CITWP","COW","SERIALNO")]
```
...
```{r}
en = fread('D:/SCU/Visualization/group project/adm2016.csv')
```