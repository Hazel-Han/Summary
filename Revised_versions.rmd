...
![](images/races.png)
But when looked at my first version graph I felt little confused because the colorful line chart. In my chart I used different color for same race's both gun right and gun control willing, which is not direct and hard to read. In new version I edited color using similar color for same race and darker color for gun control, lighter color for gun right. 
![](images/1races.png)
Also I tried to find more characters for people who tend to support gun control within dataset. Then I found people who from Urban, with race of black and hispanic, ideology are liberal and from Democrat party tend to control guns. 
